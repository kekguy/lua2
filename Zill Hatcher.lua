...
spawn(function()
    getgenv().PetHatcher = {
        ...
        Ping = "<@1456461871140966488> NEW SECRET",
        Rarities = {"Legendary", "Secret", "Infinity"},
        Ignore = {"Golden Lion", "Silly Wushi", "Moonglow Axolotl", "Moonglow Serpent", "Ardent Lantern", "Circus Stack", "Golden Balloon", "Cotton Candy", "Unicorn", "Windblume", "Spring Critter", "Aurora Dragon", "Lucky Marshmallow", "Lucky Jester", "Love Soul", "Giftbox Dark Phoenix", "Lovely Marshmallow", "Jingle Orb", "Royal Candy Cane", "Demonic Peppermint", "Snowball", "Frigid Star", "OG Cursed Scorpio", "Classic Unicorn", "Lantern Demon", "Crimson Eye",  "Ice Winged Hydra", "Classic Dominus", "King Eye", "Lovely Lotus", "Angler Fish", "Night Dweller", "Marshmallow", "Flower Pot", "Space Invader", "Neon Wire Eye", "Virus", "Hexarium", "Ghostlord", "Jellyfish", "Emerald Golem", "Minty Serpent", "Magma Cube", "Demonic Hydra", "Thorn Dragon", "Void Eye", "Stone Gargoyle", "Neon Wyvern", "Angel", "Neon Elemental", "Lunar Serpent", "Electra", "Inferno Dragon", "Cyborg Phoenix", "Crystal Unicorn", "Green Hydra", "Inferno Cube", "Dark Phoenix", "Flying Pig", "New Year's Serpent", "New Year's Blast"},
